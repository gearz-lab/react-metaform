        ...
        return <div className="live-schema-editor">
            <div className='row'>
                ...
                <div className="col-md-5">
                    ...
                    <div className='row'>
                        <div className="col-md-12">
                            <span className="pull-right">Check the <a target="blank" href="https://github.com/gearz-lab/react-metaform/blob/master/docs-md/Documentation.md#metadata">metadata documentation</a>.</span>
